...
class SucursalesPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> sucursales = [
      {"nombre": "Sucursal 1", "tel": "656 692 1697", "direccion": "Av. Vicente Guerrero #120, Col. Centro", "imagen": "https://raw.githubusercontent.com/angel-muela/imagenes-ferreteria/main/f1.jpg"},
      {"nombre": "Sucursal 2", "tel": "656 341 23 09", "direccion": "Av. de las Torres #1450, Cd. Juárez", "imagen": "https://raw.githubusercontent.com/angel-muela/imagenes-ferreteria/main/f2.jpg"},
      {"nombre": "Sucursal 3", "tel": "656 611 45 22", "direccion": "Anillo Envolvente #321, Zona Pronaf", "imagen": "https://raw.githubusercontent.com/angel-muela/imagenes-ferreteria/main/f3.jpg"},
      {"nombre": "Sucursal 4", "tel": "656 220 11 44", "direccion": "Blvd. Gómez Morín #900, Cd. Juárez", "imagen": "https://raw.githubusercontent.com/angel-muela/imagenes-ferreteria/main/f4.jpg"},
    ];
...
class BranchCard extends StatelessWidget {
  ...
  const BranchCard({super.key, required this.name, required this.phone, required this.address, required this.imageUrl, required this.width, required this.btnColor, required this.cardColor});
          ...
          Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(backgroundColor: btnColor, shape: const RoundedRectangleBorder(borderRadius: BorderRadius.zero), elevation: 4),
